    ...
    <div className="min-h-dvh w-full bg-white">
      <div className="max-w-screen-content mx-auto bg-bg-dusky-plum-base">
        <div className="px-5 min-h-dvh flex items-center sm:px-8 smLap:px-0 smLap:w-10/12 laptop:w-9/12 mx-auto">
          <div className="flex items-stretch justify-normal rounded-2xl w-full flex-col tab:flex-row">
            {/* LEFT ILLUSTRATION */}
            <div className="flex flex-col items-center justify-center tab:w-1/2 bg-white rounded-2xl shadow-2xl">
              <div>
                <div
            ...
            {/* RIGHT FORM */}
            <div className="bg-white w-full tab:w-1/2 rounded-2xl shadow-2xl flex items-center mt-6 md:mt-0">
