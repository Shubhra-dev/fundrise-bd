    ...
    <DashboardLayout activeTab={6}>
      <div className="mt-16 sm:mt-5 p-4 rounded-md bg-gray-50 w-full dark:bg-backgroundTertiary min-h-screen sm:px-5 py-2.5">
        ...
        <BodyBase extraClass={`py-4`}>
          We generally respond within 24 hours. Submit your enquiry below and one of our team
          members will get back to you. Thank you for your patience and interest.
        </BodyBase>
        <form
